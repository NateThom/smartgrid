...
class MeanStatisticForm2(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        def get_position_or_time_choices(selection):
            TUPLE_LIST = eval(selection).objects.values_list()
        ...
        if position_selection:
            self.fields['position_field'].choices=get_position_or_time_choices(position_selection)
        ...
        if time_period_selection:
            self.fields['time_period_field'].choices=get_position_or_time_choices(time_period_selection)
