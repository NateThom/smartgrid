# Generated by Django 2.1.4 on 2019-01-14 21:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aggregator', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='dash.Aggregator')),
                ('house', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='dash.House')),
                ('neighborhood', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='dash.Neighborhood')),
            ],
        ),
        migrations.CreateModel(
            name='Region',
        ...
        migrations.AlterUniqueTogether(
            name='reading',
            unique_together={('reading', 'year', 'month', 'day', 'hour', 'minute', 'second', 'house', 'neighborhood', 'aggregator', 'region', 'consumption', 'temperature', 'cost')},
        ),
        migrations.AlterUniqueTogether(
            name='neighborhood',
